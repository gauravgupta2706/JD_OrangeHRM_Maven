...
public class Sikuli_Integration_Example {
	...
	public void FileUpload_UsingSikuli() throws Exception {
		...
		String filepath = "C:\\SoftwareandTools\\Selenium_Training\\workspace\\JD_OrangeHRM_Maven\\Sikuli_Objects\\";
		...
		Pattern openButton = new Pattern(filepath+"OpenButton.JPG");
		...
		s.type(fileInputTextBox,filepath+"Hackathon.docx");
		s.click(openButton);
